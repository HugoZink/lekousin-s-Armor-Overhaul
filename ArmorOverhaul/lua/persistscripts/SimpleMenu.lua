...
menus.changelog = {}
menus.changelog.beta_0_6 = SimpleMenu:new(managers.localization:text("changelog_beta_0_6"), managers.localization:text("changelog_beta_0_6_text"), opts)
menus.changelog.beta_0_5 = SimpleMenu:new(managers.localization:text("changelog_beta_0_5"), managers.localization:text("changelog_beta_0_5_text"), opts)