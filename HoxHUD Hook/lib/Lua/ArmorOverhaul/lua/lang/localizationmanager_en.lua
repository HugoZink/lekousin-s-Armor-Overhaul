...
function LocalizationManager:text( string_id, macros )
	...
	armortext["armor_overhaul_options_localize"] = "Localize"
	armortext["armor_overhaul_options_localize_help"] = "Localizes the texts (uncheck it if you are having issues with some mods' texts)"
	armortext["armor_overhaul_options_gui"] = "Enable GUI"
	armortext["armor_overhaul_options_gui_help"] = ""
	armortext["armor_overhaul_options_gui_health"] = "Health in numbers"
	armortext["armor_overhaul_options_gui_health_help"] = "Show health in numeric values on top of health circle"
	armortext["armor_overhaul_options_gui_armor"] = "Armor in numbers"
	armortext["armor_overhaul_options_gui_armor_help"] = "Show armor in numeric values on top of armor circle"

	-- Crew bonuses
	armortext["crew_bonuses"] = "Crew bonus"
	armortext["crew_bonuses_help"] = "Allow you to boost crew members using ArmorOverhaul 0.6. Does not apply to yourself"
	armortext["crew_bonus_xp_multiplier"] = "XP +10%"
	armortext["crew_bonus_armor_multiplier"] = "Armor +10%"
	armortext["crew_bonus_health_multiplier"] = "Health +20%"
	armortext["crew_bonus_deflect_chance_addend"] = "Deflect chance +10%"
